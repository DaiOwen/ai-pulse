...
> 💡 **只看新闻不想折腾？** 直接访问上面的在线演示链接就行了——每天三次自动更新，什么都不用装。如果想订阅，可以用 [RSS 阅读器](feed.xml) 接收每日推送。
...
**Q: 我不想安装 Claude Code，能只看新闻吗？**
A: 可以。有两种方式：
- 直接访问在线演示：**[https://daiowen.github.io/ai-pulse/](https://daiowen.github.io/ai-pulse/)**，无需安装任何东西
- clone 项目后 `git pull` 拉取最新 `index.html`，浏览器直接打开即可阅读
